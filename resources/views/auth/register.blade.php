...
f
                        ...
                        <div class="row mb-3">
                            <label for="hakkinda" class="col-md-4 col-form-label text-md-end">Bize Kendinden Bahset</label>
                            <div class="col-md-6">
                                <textarea id="hakkinda" class="form-control @error('hakkinda') is-invalid @enderror" name="hakkinda" required autocomplete="off" rows="4"></textarea>
                                @error('hakkinda')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
